...
{ 
  ...
  //char address1[20];
  //char address2[20];
  //er_sprintf(address1, "%p", soap);
  //er_sprintf(address2, "%p", soap->local_namespaces);
  //er_fprintf(stderr, "soap_begin_count(%s:%s) : SOAP_FREE(soap, soap->local_namespaces)\n",address1,address2);

  //27-Apr-2022 YR BZ#56228
  if (soap->local_namespaces != NULL)
  {
    if(soap->local_namespaces[1].out != NULL)
      SOAP_FREE(soap, soap->local_namespaces[1].out);
    //26-Jul-2021 YR BZ#54709
  ...
  //er_fprintf(stderr, "soap_begin_count calling soap_set_local_namespaces (%s)\n",address);
...
{ 
  ...
  //er_sprintf(address1, "%p", soap);
  //er_sprintf(address2, "%p", soap->local_namespaces);
  //er_fprintf(stderr, "soap_begin_send(%s:%s) : SOAP_FREE(soap, soap->local_namespaces)\n",address1,address2);
  ...
  //char address[20];
  //er_sprintf(address, "%p", soap);
  //er_fprintf(stderr, "soap_begin_send calling soap_set_local_namespaces (%s)\n",address);
  soap_set_local_namespaces(soap);
#ifdef WITH_ZLIB
...
{ soap->part = SOAP_END;
  ...
  //er_sprintf(address1, "%p", soap);
  //er_sprintf(address2, "%p", soap->local_namespaces);
  //er_fprintf(stderr, "soap_end_recv(%s:%s) : SOAP_FREE(soap, soap->local_namespaces)\n",address1,address2);
...
{ 
  ...
  { for (; ns->id; ns++)
    ...
    //er_sprintf(address1, "%p", soap);
    //er_sprintf(address2, "%p", soap->local_namespaces);
    //er_fprintf(stderr, "soap_free_temp(%s:%s) : SOAP_FREE(soap, soap->local_namespaces)\n",address1,address2);
    if (soap->local_namespaces != NULL)
    {
      if (soap->local_namespaces[1].out != NULL)
        SOAP_FREE(soap, soap->local_namespaces[1].out);
...
{ if (copy == soap)
  ...
  { struct soap_plugin *p = NULL;
    ...
    //char address[20];
    //er_sprintf(address, "%p", copy);
    //er_fprintf(stderr, "soap_copy_context calling soap_set_local_namespaces (%s)\n",address);
...
{ struct soap_attribute *tp = NULL, *tq;
  ...
  //char address1[20];
  //char address2[20];
  //er_sprintf(address1, "%p", copy);
  //er_sprintf(address2, "%p", copy->local_namespaces);
  //er_fprintf(stderr, "soap_copy_stream(%s:%s) : SOAP_FREE(soap, soap->local_namespaces)\n",address1,address2);

  //27-Apr-2022 YR BZ#56228
  SOAP_FREE(copy, copy->local_namespaces[1].out);
  //26-Jul-2021 YR BZ#54709
  SOAP_FREE(copy, copy->local_namespaces);
  copy->local_namespaces = NULL;

  //char address[20];
  //er_sprintf(address, "%p", copy);
  //er_fprintf(stderr, "soap_copy_stream calling soap_set_local_namespaces (%s)\n",address);
...
{ 
  //char address[20];
  //er_sprintf(address, "%p", soap);
  //er_fprintf(stderr, "soap_set_version calling soap_set_local_namespaces (%s)\n",address);
  soap_set_local_namespaces(soap);
...
{ struct Namespace *ns = soap->local_namespaces;
  ...
  //char address[20];
  //er_sprintf(address, "%p", soap);
  //er_fprintf(stderr, "soap_set_namespaces calling soap_set_local_namespaces (%s)\n",address);
  soap_set_local_namespaces(soap);
...
{ 
  ...
  { 
    ...
    { 
      ...
      //er_sprintf(address1, "%p", soap);
      //er_sprintf(address2, "%p", soap->local_namespaces);
      //er_fprintf(stderr, "soap_set_local_namespaces(%s:%s) : SOAP_MALLOC(soap, soap->local_namespaces)\n",address1,address2);
      for (; ns2->id; ns2++)
        ns2->out = NULL;
    }
  }
...
{ soap_wchar c;
  ...
  if ((soap->mode & SOAP_XML_DOM) && soap->dom)
  { if (!soap->dom->code || !*soap->dom->code)
...
{ soap_wchar c;
  ...
  //char address[20];
  //er_sprintf(address, "%p", soap);
  //er_fprintf(stderr, "soap_begin_recv calling soap_set_local_namespaces (%s)\n",address);
  soap_set_local_namespaces(soap);
...
{ int status = soap->error;
  ...
  { int r = 1;
    ...
    if (r > 0)
    { soap->error = SOAP_OK;
      if (soap->local_namespaces && soap->local_namespaces[0].id && soap->local_namespaces[0].ns && soap->local_namespaces[1].id && soap->local_namespaces[1].ns)
