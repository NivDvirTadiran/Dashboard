...
import { ExamplePieChartWidgetComponent } from "./example-pie-chart-widget.component";
...
export default {
  ...
  component: ExamplePieChartWidgetComponent,
  parameters: {
...
const Template: StoryFn<ExamplePieChartWidgetComponent> =  (args) => ({
  props: args,
});
