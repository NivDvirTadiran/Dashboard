...
export default {
  ...
  decorators: [
    moduleMetadata({
      declarations: [/* ButtonLanguageComponent, ButtonTadiranComponent*/],
...
const Template: (args: Background2Component) => { props: Background2Component } = (args: Background2Component) => ({
  props: args,
});
