...
import LoginService from "../login2/login-main/login.service";
import {AppConfig} from "../app.config";
import { ResponseInfoHeaderType, DataItemRow } from '../services/emis-soap.service'; // Import necessary types
...
export interface BlockItemDto {
  blockName: string;
  blockData: DataItemRow[];
}

export interface DetailResponseDto {
  responseInfoHeader: ResponseInfoHeaderType;
  returnArray: BlockItemDto[]; // Or List<BlockItemDto> depending on how you want to represent it
}
